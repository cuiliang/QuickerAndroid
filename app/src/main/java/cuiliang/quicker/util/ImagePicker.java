...
public class ImagePicker {
    private static final int DEFAULT_MIN_WIDTH_QUALITY = 1200;        // min pixels
...
//        return bm;
        ...
        int sampleSize = calculateInSampleSize(context, selectedImage, 1200, 1200);
        Log.d(TAG, "sampleSize = " + sampleSize);

        return decodeBitmap(context, selectedImage, sampleSize);
    }
