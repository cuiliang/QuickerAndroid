 ...
 * TODO
 */
class FactorItemAdapter(private val context: Context) :
    RecyclerView.Adapter<FactorItemAdapter.ItemViewHolder>() {
    private val items = ArrayList<TaskEditItemData>()
    private var footerViewData: TaskEditItemData? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        return ItemViewHolder(
            LayoutInflater.from(context).inflate(R.layout.layout_task_edit_item, parent, false)
        )
    }
