...
class MyTaskFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        taskListAdapter = TaskListAdapter(requireActivity()) { data: TaskData ->
    ...
    private fun readFileConfig() {
        ...
        taskListAdapter.addTask(TaskData("WebSocket通知", "WebSocket连接成功通知", true))
        taskListAdapter.addTask(TaskData("充电通知", "电量低于20%", false))
    }
